        ...
        <div class="row wrapper">
          ...
          <div class="col-4 left-side">
            ...
            <div class="row">
              ...
              <h6 class="p-3 text-white"><span class="mx-2 round-number bg-grey">2</span> Akun Bank</h6>
            </div>
            ...
            <div class="form-wrapper">
              <form action="{{ route('artists.register') }}" method="post">
                ...
                <div class="mt-4 d-flex justify-content-end">
                  <button type="submit" class="submit-button rounded-circle"><i class="fas fa-arrow-right"></i></button>
                </div>
              </form>
            </div>
